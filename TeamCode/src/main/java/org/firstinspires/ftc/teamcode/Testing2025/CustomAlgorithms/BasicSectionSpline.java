 ...
 * This class fits a smooth spline paths through a series of 2d points
 * No endpoint tangent controls are included
 * Guide points for the spline paths between each guide point are automatically generated based on a "weight"
 * Guide points can be adjusted, but there is no constraint to maintain tangency
 * Angle following is also included for more efficiency, but doesn't include any lookahead
 */
public class BasicSectionSpline {
    /*
    ...
    */
    ...
    public BasicSectionSpline(double [][] roots, double weight) { // Weight raw-translated to distance
