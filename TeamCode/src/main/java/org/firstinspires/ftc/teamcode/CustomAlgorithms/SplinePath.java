 ...
 * This class fits an individual splinepath through two points, guided by guide points
 * There are no tangency constraints on the endpoints
 * No weight settings for closeness of the path to guide points are included, so nterpolate method helps to get corners tighter
 */
